...
func (pq *PositionQuery) QueryFormposition() *SalaryQuery {
	query := &SalaryQuery{config: pq.config}
...
func (pq *PositionQuery) WithFormposition(opts ...func(*SalaryQuery)) *PositionQuery {
	query := &SalaryQuery{config: pq.config}
...
//		GroupBy(position.FieldPosition).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
