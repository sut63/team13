...
func (rc *RoleCreate) AddTodoIDs(ids ...int) *RoleCreate {
	rc.mutation.AddTodoIDs(ids...)
	return rc
}

// AddTodo adds the todo edges to Employeeworkinghours.
func (rc *RoleCreate) AddTodo(e ...*Employeeworkinghours) *RoleCreate {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
	return rc.AddTodoIDs(ids...)
}
...
func (rc *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if nodes := rc.mutation.TodoIDs(); len(nodes) > 0 {
