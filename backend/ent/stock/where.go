...
func PriceproductEQ(v float64) predicate.Stock {
	return predicate.Stock(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPriceproduct), v))
	})
}
...
func PriceproductNEQ(v float64) predicate.Stock {
	return predicate.Stock(func(s *sql.Selector) {
...
func PriceproductIn(vs ...float64) predicate.Stock {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceproductNotIn(vs ...float64) predicate.Stock {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceproductGT(v float64) predicate.Stock {
	return predicate.Stock(func(s *sql.Selector) {
...
func PriceproductGTE(v float64) predicate.Stock {
	return predicate.Stock(func(s *sql.Selector) {
...
func PriceproductLT(v float64) predicate.Stock {
	return predicate.Stock(func(s *sql.Selector) {
...
func PriceproductLTE(v float64) predicate.Stock {
	return predicate.Stock(func(s *sql.Selector) {
