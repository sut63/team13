...
// AddFormposition adds the formposition edges to Salary.
func (pu *PositionUpdate) AddFormposition(s ...*Salary) *PositionUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
// RemoveFormposition removes formposition edges to Salary.
func (pu *PositionUpdate) RemoveFormposition(s ...*Salary) *PositionUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
// AddFormposition adds the formposition edges to Salary.
func (puo *PositionUpdateOne) AddFormposition(s ...*Salary) *PositionUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
// RemoveFormposition removes formposition edges to Salary.
func (puo *PositionUpdateOne) RemoveFormposition(s ...*Salary) *PositionUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
