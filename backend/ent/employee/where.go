...
// HasWhose applies the HasEdge predicate on the "whose" edge.
func HasWhose() predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(WhoseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, WhoseTable, WhoseColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasWhoseWith applies the HasEdge predicate on the "whose" edge with a given conditions (other predicates).
func HasWhoseWith(preds ...predicate.EmployeeWorkingHours) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(WhoseInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, WhoseTable, WhoseColumn),
		)
...
// HasEmployeestock applies the HasEdge predicate on the "employeestock" edge.
func HasEmployeestock() predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(EmployeestockTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, EmployeestockTable, EmployeestockColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasEmployeestockWith applies the HasEdge predicate on the "employeestock" edge with a given conditions (other predicates).
func HasEmployeestockWith(preds ...predicate.Stock) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(EmployeestockInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, EmployeestockTable, EmployeestockColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
// HasFormemployee applies the HasEdge predicate on the "formemployee" edge.
func HasFormemployee() predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasFormemployeeWith applies the HasEdge predicate on the "formemployee" edge with a given conditions (other predicates).
func HasFormemployeeWith(preds ...predicate.Salary) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
