...
// HasFormcustomer applies the HasEdge predicate on the "formcustomer" edge.
func HasFormcustomer() predicate.Customer {
	return predicate.Customer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FormcustomerTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, FormcustomerTable, FormcustomerColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasFormcustomerWith applies the HasEdge predicate on the "formcustomer" edge with a given conditions (other predicates).
func HasFormcustomerWith(preds ...predicate.Orderonline) predicate.Customer {
	return predicate.Customer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FormcustomerInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, FormcustomerTable, FormcustomerColumn),
		)
