...
// UpdateOne returns an update builder for the given entity.
func (c *EmployeeworkinghoursClient) UpdateOne(e *Employeeworkinghours) *EmployeeworkinghoursUpdateOne {
	mutation := newEmployeeworkinghoursMutation(c.config, OpUpdateOne, withEmployeeworkinghours(e))
...
// DeleteOne returns a delete builder for the given entity.
func (c *EmployeeworkinghoursClient) DeleteOne(e *Employeeworkinghours) *EmployeeworkinghoursDeleteOne {
	return c.DeleteOneID(e.ID)
}
...
// QueryWorkinghour queries the workinghour edge of a Employeeworkinghours.
func (c *EmployeeworkinghoursClient) QueryWorkinghour(e *Employeeworkinghours) *EmployeeQuery {
...
func (c *EmployeeworkinghoursClient) QueryDay(e *Employeeworkinghours) *DayQuery {
...
func (c *EmployeeworkinghoursClient) QueryShift(e *Employeeworkinghours) *ShiftQuery {
...
func (c *EmployeeworkinghoursClient) QueryRole(e *Employeeworkinghours) *RoleQuery {
